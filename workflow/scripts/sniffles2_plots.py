...
def main():
    ...
    if os.path.isfile(input_file_path):
        ...
        print(file_name)
        os.system(
            f"python /mnt/ccrsf-ifx/Software/tools/sniffles/sniffle2_plot/vcf_visulaizer.py -i {input_file_path} -o {output_file_path}"
        )
    else:
        for file_entry in os.scandir(input_file_path):
            ...
            if file_name.lower().endswith(".vcf"):
                ...
                os.system(
                    f"python /mnt/ccrsf-ifx/Software/tools/sniffles/sniffle2_plot/vcf_visulaizer.py -i {file_path} -o {directory_path}"
                )
